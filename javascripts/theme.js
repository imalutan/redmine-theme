...
function createBtn() {
	...
	$(".tab-content p a.icon").addClass("btn btn-sm btn-primary");
        ...
        $("a.icon.icon-zoom-in").addClass("btn btn-sm btn-outline-dark");
        $("a.icon.icon-zoom-out").addClass("btn btn-sm btn-outline-dark");
	...
	$(".icon-fav").addClass("btn btn-sm btn-outline-dark");
...
function init() {
	...
	createDOMObserver(document.querySelectorAll('body')[0], (mutationsList, observer) => {
	  ...
	  $("icon.icon-fav").addClass("btn btn-sm btn-outline-dark");
	  $("icon.icon-fav-off").addClass("btn btn-sm btn-outline-dark");
        }
    }
	});
}
